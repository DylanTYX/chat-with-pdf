...
export const indexName = "dylantyx";
...
export async function generateEmbeddingsInPineconeVectorStore(docId: string) {
  ...
  if (namespaceAlreadyExists) {
    ...
    /* If the namespace does not exist, download the PDF from the Firestore via the stored 
    Download URL and generate the embeddings and store them in the Pinecone vector store. */
